...
|@stopwords_path@|A path (either relative to @config@ location, or absolute) to a stopwords file configuration. Each stop word should be in its own "line" (separated by \n). The file is read in UTF8 format.|
